...
<div class="publication-highlights">
  ...
  <div class="row align-items-center my-4">
    <div class="col-md-6 mb-3 mb-md-0">
      <img class="img-fluid rounded" src="{{ '/assets/img/highlights/telo21.png' | relative_url }}" alt="TELO21 highlight">
    </div>
    <div class="col-md-6">
      <p>[<a href="https://dl.acm.org/doi/10.1145/3465335">TELO21</a>] refutes a common belief through a set of artificial sequences and shows that Pareto-based, indicator-based, and decomposition-based criteria may fail on extremely simple Pareto front shapes, such as 1D and 2D simplexes. [<a href="{{ '/basic-research/multi-objective-archiving/archiving-failed-on-simplex-shapes/' | relative_url }}">Read More</a>]</p>
    </div>
  </div>
  ...
  <div class="row align-items-center my-4">
    <div class="col-md-6 mb-3 mb-md-0">
      <img class="img-fluid rounded" src="{{ '/assets/img/highlights/ecj20.png' | relative_url }}" alt="ECJ20 highlight">
    </div>
    <div class="col-md-6">
      <p>[<a href="https://www.mitpressjournals.org/doi/abs/10.1162/evco_a_00269">ECJ20</a>] proposes an adaptive weight update approach that enables decomposition-based EMO methods to work well for any Pareto front shape. [<a href="https://arxiv.org/pdf/1709.02679">PDF</a>] [<a href="{{ '/basic-research/solving-multi-objective-problems/adapting-weights-for-moead/' | relative_url }}">Read More</a>]</p>
    </div>
  </div>
